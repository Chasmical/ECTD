...
#### Версия игры: v89 и новее<br/>Версия мода: v2.4<br/>Автор мода: Abbysssal#2020 ####
...
*	Ставить новые добавляемые этим модом мутаторы;
...
* **[ECTD] Ракетные пули** - Заменяет абсолютно все снаряды на ракеты. Скорость стрельбы не изменена.
* **[ECTD] Безлиминые наггетсы** - Если включен, позволяет вам набирать более 99 наггетсов. Если выключен, НЕ сбрасывает количество наггетсов.
* **[ECTD] Хрупкий игрок** - При получении малейшего урона, вы сразу умираете.
* **[ECTD] Гигантские взрывы** - Делает все взрывы в два раза сильнее.
* **[ECTD] Супер-скорость** - Всё в игре происходит в 2 раза быстрее.
